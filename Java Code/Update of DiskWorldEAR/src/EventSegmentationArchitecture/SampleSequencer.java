...
public class SampleSequencer{
	...
	public Sample getSample(){
		...
		return new Sample(inputTemp, targetTemp);
	}
	
	
	
	/**
	 * The method is equivalent to update and get Sample
	 * @param input the latest input
	 * @param target the latest target
	 * @return
	 */
	public  Sample addSample(double[] input, double[] target) {
