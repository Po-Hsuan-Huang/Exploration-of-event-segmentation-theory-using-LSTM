...
public interface ForwardModel {
	...
	/**
	 * Set the method to Online if the value is True.
	 * The default value is true.
	 * This method is implemented because LSTM needs consecutive data sequence to
	 * made correct prediction. The online has to be set to false in consecutive predict.
	 */
