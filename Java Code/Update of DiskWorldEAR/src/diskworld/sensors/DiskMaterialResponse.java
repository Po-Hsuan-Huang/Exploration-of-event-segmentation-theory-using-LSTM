...
/**
 * Interface for sensors that respond with material specific values (e.g. RGB values)
 * 
 * @author Jan
 * 
 */
public interface DiskMaterialResponse {
	 ...
	 * that array has sufficient lentgh.
	 * 
	 * @param material
	 *            the material for which the measurement value is to be determined
	 * @param measurement
	 ...
	 */
	public void putResponse(DiskMaterial material, double[] measurement, int startIndex);
