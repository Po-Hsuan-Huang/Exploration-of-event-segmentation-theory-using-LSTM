...
public class XORExample {
    ...
    //
    // define set as a static buffer of samples.
    //
    public static SampleSet set = new SampleSet();

    public static  void update(double[] input, double[] target){
    	Sample sample =  new Sample(input,target,2,1,1,1);
    	set.add(sample);
    }
    ...
    public static void main(String[] args) throws IOException, ClassNotFoundException {
        ...
        update(array(0, 1), array(1));
        update(array(1, 0), array(1));
        update(array(1, 1), array(0));
