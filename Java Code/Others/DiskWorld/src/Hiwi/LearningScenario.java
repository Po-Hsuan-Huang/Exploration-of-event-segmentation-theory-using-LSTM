...
public class LearningScenario implements ScenarioManager {
	
	int timeToAddHeavyBurrdock = 10000;
	int timeToAddBurrdock = 15000;//30000;
	int timeForAll = 20000;//35000;
	...
	public LearningScenario(Random r){
		this.r = r;
	}
