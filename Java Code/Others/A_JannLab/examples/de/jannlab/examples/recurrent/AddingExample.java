 ...
 * problem from [1]. <br>
 * </br> For this experiment samples are generated as follows: <br>
 * </br>
 * <ul>
 * <li>Given a sequence of T vectors from R2, where the x part of each sequence
 * is randomly chosen from [0,1].</li>
 ...
 * </ul>
 * <br>
 * </br> [1] S. Hochreiter und J. Schmidhuber,
 * "LSTM Can Solve Hard Long Time Lag Problems", ADVANCES IN NEURAL INFORMATION
 * PROCESSING SYSTEMS 9, S. 473--479, 1997. <br>
 * </br>
 * 
...
public class AddingExample {
	...
	public static void main(String[] args) throws IOException {
		...
		final double thres = 0.04;
		{
			...
			System.out.println("validation set result (1): "
					+ (v.ratio() * 100) + "%.");
		}
		{
			RegressionValidator v = new RegressionValidator(net, thres);
			...
			System.out.println("validation set result (2): "
					+ (v.ratio() * 100) + "%.");
		}
		{
			RegressionValidator v = new RegressionValidator(net, thres);
