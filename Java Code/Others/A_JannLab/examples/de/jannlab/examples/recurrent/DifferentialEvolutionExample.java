...
/**
 * This simple example demonstrates how Differential Evolution can be used for
 * learning a damped oscillation function with a Recurrent Neural Network. <br>
 * </br>
 * 
...
public class DifferentialEvolutionExample {
	...
	public static double X_INCR = X_RANGE / TICKS;

	/**
	 * Damped oscillation function, which is learned by the RNN.
	 */
	public static double f(final double x) {
		final double xf = x * 1.0;
		return (Math.sin(xf) * Math.exp(-(0.075 * xf)));
	}

	/**
	 * This error function computes the mean square error of the network output
	 * sequence and the oscillation function f. This function is used as
	 * objective function for the Differential Evolution optimization process.
	 */
	...
	/**
	 * This static method generated a Recurrent Neural Network with a specific
	 * number of hidden neurons. Hidden and output layer a activated with the
	 * standard sigmoidal function of the range [-1, 1].
	 */
	...
	public static void main(String[] args) {
		...
		final OnlineDiagram diagram = new OnlineDiagram(300, -1.0, 1.0, 1) {
		...
		diagram.addMouseListener(new MouseAdapter() {
			...
			public void mousePressed(MouseEvent e) {
				input[0] = (e.getButton() == MouseEvent.BUTTON1) ? (1.0)
						: -(1.0);
			}
		...
		JFrame frame = new JFrame(
				"Damped Oscillation learned by a Recurrent Neural Network ");
