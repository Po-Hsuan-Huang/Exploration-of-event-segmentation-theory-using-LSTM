...
/**
 * A simple example of learning XOR with a small multilayer perceptron. Using
 * sigmoidal function of range [-2, 2] for activation provides the fastest
 * convergence speed in training. Tanh works also nice. Note, that when standard
 * sigmoid is used for activation, a bias neuron has to be added. <br>
 * </br>
 * 
...
public class XORExample {
	...
	public static void main(String[] args) throws IOException,
		...
		for (Sample s : set) {
			...
			mlp.compute();
			mlp.output(out, 0);
			System.out.println(DoubleTools.asString(s.getInput(), 1) + " ==> "
