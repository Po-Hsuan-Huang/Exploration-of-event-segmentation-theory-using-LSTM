...
/**
 * This class is a vector of two float values x, y. It contains some static
 * methods for operating in R2 (2 dimensional space). <br>
 * </br>
 * 
...
public class Vector2f {
	...
	/**
	 * Creates in instance of Vector2f by a given Vector3f. The x and y value
	 * will by divided by the z-value.
	 * 
	 * @param v
	...
	/**
	 * Creates an instance of Vector2f for a given x and y value. <br>
	 * </br>
	 * 
	 * @param px
	 *            The x value.
	...
	/**
	 * Creates an instance of Vector2f by a given Vector2f. <br>
	 * </br>
	 * 
	 * @param pv
	 *            An Instance of Vector2f.
	 */
	...
	/**
	 * Copy the values of a given Vector2f. <br>
	 * </br>
	 * 
	 * @param pv
	 *            An instance of Vector2f.
	...
	/**
	 * Creates a copy this instance. <br>
	 * </br>
	 * 
	...
	/**
	 * Computes the squared length of the vector (euclidian). Can be used as a
	 * faster metric then length, of only the relative order of the vectors is
	 * needed.
	 * 
	...
	/**
	 * Adds two given Vector2f instances and stores the value in a third
	 * instance.
	 * 
	 * @param pv1
	 *            The first instance.
	...
	/**
	 * Subtracts two given Vector2f instances and stored the result in a third
	 * Vector2f instance.
	 * 
	 * @param pv1
	 *            The first instance.
	...
	/**
	 * Subtracts two given Vector2f instances and return a new instance of
	 * Vector2f.
	 * 
	 * @param pv1
	 *            The first instance.
	...
	/**
	 * Multiplies a Vector2f instance with a given scalar value and stores the
	 * result in a second Vector2f instance.
	 * 
	 * @param pv
	 *            An instance of Vector2f.
	 * @param pscalar
	...
	/**
	 * Multiplies a given vector with a scalar value. The method changes the
	 * given vector instance.
	 * 
	 * @param pv
	 *            The vector.
	 * @param pscalar
