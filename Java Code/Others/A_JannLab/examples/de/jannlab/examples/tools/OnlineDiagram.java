...
/**
 * A simple swing based online-diagram for visualization of data sequences. <br>
 * </br>
 * 
...
public class OnlineDiagram extends JPanel {
	...
	private Stroke dotted = new BasicStroke(1f, BasicStroke.CAP_ROUND,
	...
	public OnlineDiagram(final int length, final double lbd, final double ubd,
			final int curves) {
	...
	protected void paintComponent(Graphics g) {
		...
		g2.drawLine(0, (int) (0.75 * this.getHeight()), this.getWidth() - 1,
				(int) (0.75 * this.getHeight()));
		g2.drawLine(0, (int) (0.5 * this.getHeight()), this.getWidth() - 1,
				(int) (0.5 * this.getHeight()));
		g2.drawLine(0, (int) (0.25 * this.getHeight()), this.getWidth() - 1,
		...
		for (int l = 0; l < this.curves; l++) {
			...
			for (int i = 1; i < this.drawlength; i++) {
				...
				final int yy2 = hi
						- yValue(line[(this.drawoffset + i) % this.length]);
				//
