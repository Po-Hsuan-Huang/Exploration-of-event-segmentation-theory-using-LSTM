...
/**
 * This example demonstrates how to setup LSTM networks. <br>
 * </br>
 * 
...
public class LSTMGeneratorExample {
	...
	/**
	 * Creates a hidden layer with n LSTM blocks. <br>
	 * </br>
	 * 
	 * @param gen
	 *            Instance of NetCoreGenerator.
	 * @param blocksnum
	 *            Number of LSTM blocks
	 * @param gates
	 *            CellType of the gates.
	 * @param netin
	 *            CellType of cell-input.
	 * @param states
	 *            CellType of cell-outpt.
	 * @param peepholes
	 *            Use peepholes?
	 * @return Layer index.
	 */
	public static int hiddenLayer(final NetCoreGenerator gen,
			final int blocksnum, final CellType gates, final CellType netin,
			final CellType states, final boolean peepholes) {
		//
		// create lstmlayer.
		//
