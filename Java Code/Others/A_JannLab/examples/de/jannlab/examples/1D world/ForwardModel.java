 package 
/**
 * Forward model implementation for the Event Segmentation Architecture. The
 * forward model predicts sensory changes based on motor commands and are
...
public interface ForwardModel {
	...
	/**
	 * ForwardModel keeps track of the prediction error over the last T-time
	 * steps (T=1000 in LinearRLSModel).
	 * 
	 * @param e
	 ...
	 * 
	 * @return mean error of prediction of the last T-time steps this model was
	 *         active
	 */
	 ...
	 * 
	 * @return variance of the prediction error over the last T-time steps this
	 *         model was active
	 */
	...
	/**
	 * Create a hard copy of this forward model. Only difference is, that the
	 * prediction mean prediction error and the variance of the prediction error
	 * are reset in the copy.
	 * 
	...
	/**
	 * Create a hard copy of this forward model, also containing the stored
	 * prediction erros of the last T-time steps.
	 * 
	 * @return hard copy of the forward model
	 */
